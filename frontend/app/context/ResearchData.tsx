...
export const ResearchDataProvider: React.FC<ResearchDataProviderProps> = ({children}) => {
...
export const useResearchData = ():ResearchDataContextType => {
    ...
    if(!context){
        throw new Error('useResearchsData must be used within an ResearchDataProvider')
    }
